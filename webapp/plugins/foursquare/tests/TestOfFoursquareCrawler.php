...
class TestOfFoursquareCrawler extends ThinkUpUnitTestCase {
    ...
    public function testFetchInstanceUserCheckins() {
        ...
        $this->assertEqual($place['map_image'], 'http://maps.googleapis.com/maps/api/staticmap?size=150x150&zoom=15&maptype=roadmap&markers=color:blue%7C52.477241961421,-1.4845029364055&sensor=false');
        ...
        $link = $link_dao->getLinkByUrl('https://img-s.foursquare.com/pix/noTc5a0afTgqTuLlsi3a33tLR0iUOZaa2hLm7LsNn1Q.jpg');
        
        // Check the expanded url was set correctly
        $this->assertEqual($link->expanded_url, 'https://img-s.foursquare.com/pix/noTc5a0afTgqTuLlsi3a33tLR0iUOZaa2hLm7LsNn1Q.jpg');
        ...
        $this->assertEqual($link->image_src, 'https://img-s.foursquare.com/pix/noTc5a0afTgqTuLlsi3a33tLR0iUOZaa2hLm7LsNn1Q.jpg');
