...
<div class="append_20 alert helpful">
    ...
    <div class="">
    <p>The foursquare plugin collects badges ! </p>
...
<li><a href="https://foursquare.com/oauth/" target="_blank" style="text-decoration : underline;">Register a new project with foursquare</a></li>
<li>  Fill in the application settings and set the callback URL to: 
    <small>
